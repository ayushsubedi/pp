...
- A portfolio showing real shipped product design work, ideally a SaaS or a data/document-heavy product
- Comfortable designing for both mobile (Flutter-buildable) and server-rendered web (forms, tables, documents — not a SPA)
- Figma fluency and real developer-handoff experience
- Available for a fixed-scope engagement (project fee, not hourly or FTE) aligned to Phase 1's timeline
